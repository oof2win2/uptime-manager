...
import { UserModel, useSignupOrLoginMutation } from "src/generated/graphql"
import { Redirect } from "react-router"
import { setUser } from "src/redux/user"
import { useAppDispatch } from "src/redux/store"

const Login: React.FC = () => {
	const [{ data: SignupData, fetching }, SignupOrLogin] =
	...
	useEffect(() => {
		dispatch(setUser(SignupData?.SignupOrLogin.user as UserModel))
